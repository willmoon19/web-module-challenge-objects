...
const mocha = createMenuItem("mocha", 5, "drink");
const macchiato = createMenuItem("macchiato", 3, "drink");
console.log(pizza, mocha, macchiato);
...
*/
reviews.push({name: "Will", rating: 4,feedback: "was good."});
console.log(reviews);
